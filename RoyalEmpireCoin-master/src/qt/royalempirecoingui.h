...
/**
  RoyalEmpireCoin GUI main class. This class represents the main window of the RoyalEmpireCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class RoyalEmpireCoinGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit RoyalEmpireCoinGUI(QWidget *parent = 0);
    ~RoyalEmpireCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a royalempirecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
