...
{
    BOOST_CHECK(TestSplitHost("www.royalempirecoin.org", "www.royalempirecoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.royalempirecoin.org]", "www.royalempirecoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.royalempirecoin.org:80", "www.royalempirecoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.royalempirecoin.org]:80", "www.royalempirecoin.org", 80));
