...
static const int64_t COIN_YEAR_REWARD = 12 * CENT; // 12% Annual stake PoS
...
public:
    ...
    /** Amount of royalempirecoins spent by this transaction.
    ...
    /** Amount of royalempirecoins coming in to this transaction
